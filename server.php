  ...
  function updateUserInfo($param) { 
    if (!$this->aaa->has_right('openruth', 500))
      ...
      if ($tgt = $targets[$agencyId]) {
        ...
        if ($param->userAbsenceStartDate->_value) $bor->AbsenceStart->_value = $param->userAbsenceStartDate->_value;
        if ($param->userAbsenceEndDate->_value) $bor->AbsenceEnd->_value = $param->userAbsenceEndDate->_value;
